...
const CustomSidebar = ({ onMenuItemClick }) => {
  ...
  return (
    <div className='border w-100 border-end h-[100vh] bg-white text-black'>
      <ul className='pt-[20px]'>
        <li className={`flex items-center py-6 px-[18px] text-xl ${activeItem === 0 ? 'bg-gray-200' : ''}`}>
          ...
          >
            <Icon as={FaEnvelope} boxSize={6} color={activeItem === 0 ? 'cyan.800' : 'inherit'} className='mx-4' />
            Email Services
          </chakra.a>
        </li>
        <li className={`flex items-center py-6 px-[18px] text-xl ${activeItem === 1 ? 'bg-gray-200' : ''}`}>
          ...
          >
            <Icon as={FaFileAlt} boxSize={6} color={activeItem === 1 ? 'cyan.800' : 'inherit'} className='mx-4' />
            Email Templates
          </chakra.a>
        </li>
        <li className={`flex items-center py-6 px-[18px] text-xl ${activeItem === 2 ? 'bg-gray-200' : ''}`}>
          ...
          >
            <Icon as={FaUser} boxSize={6} color={activeItem === 2 ? 'cyan.800' : 'inherit'} className='mx-4' />
            Personal Settings
          </chakra.a>
        </li>
      </ul>
